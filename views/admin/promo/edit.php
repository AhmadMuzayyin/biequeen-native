...
$voucher = mysqli_query($conn, "SELECT * FROM vouchers WHERE id = $voucher_id limit 1");
$voucher = mysqli_fetch_assoc($voucher);
?>
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Kode Promo</h1>
    </div>
    <!-- Content Row -->
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <form action="/config/promo.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" min="1000" class="form-control" id="nominal" name="nominal" value="<?= $voucher['nominal'] ?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="tanggal_berakhir" class="col-sm-3 col-form-label">Tanggal Berakhir</label>
                            <div class="col-sm-9">
                                <input type="date" class="form-control" id="tanggal_berakhir" name="tanggal_berakhir" value="<?= $voucher['tanggal_berakhir'] ?>">
                            </div>
                        </div>
